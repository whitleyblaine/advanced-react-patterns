...
This prevents us from having to add code for every use case that people come up with during the life of our reusable component.

Inversion of control algorithm:
...
We seem to do this by passing a custom, optional reducer to a custom hook.
