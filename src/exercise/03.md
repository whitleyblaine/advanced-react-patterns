...
The Flexible Compound Components Pattern uses React context, which allows you to handle nested children (grandchildren).

You should use this version of the pattern more often.
