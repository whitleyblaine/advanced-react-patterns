...
The Prop Collections and Getters Pattern allows your hook to support common use cases for UI elements people build with your hook (e.g. accessibility).

These props can be hard to remember, and it's nice if we can make it easier for people to use our components and hooks the right way.
